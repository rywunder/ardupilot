...
void AC_AttitudeControl_Multi::rate_controller_run()
{
    ...
    if(true)
    {
        // Call the AC heli code here 
        _motors.set_pitch(get_rate_pitch_adap().update(AP::ins().get_loop_rate_hz(), _rate_target_ang_vel.y, gyro_latest.y));
        _motors.set_roll(get_rate_roll_adap().update(AP::ins().get_loop_rate_hz(), _rate_target_ang_vel.x, gyro_latest.x));
    }
    else
    {
